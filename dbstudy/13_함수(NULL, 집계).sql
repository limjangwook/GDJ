...
INSERT INTO STUDENT(NAME, KOR, ENG, MATH) VALUES(NULL, 100, 100, 100);
INSERT INTO STUDENT(NAME, KOR, ENG, MATH) VALUES('영숙', NULL, 100, 100);
INSERT INTO STUDENT(NAME, KOR, ENG, MATH) VALUES('정수', 100, NULL, 100);
INSERT INTO STUDENT(NAME, KOR, ENG, MATH) VALUES('지영', 100, 100, NULL);
COMMIT;
...
SELECT
      ...
      , SUM(ENG)
      , SUM(MATH)
--    , SUM(KOR, ENG, MATH)  인수(ARGUMENTS)가 3개이므로 불가능함(인수 1개여야함)
