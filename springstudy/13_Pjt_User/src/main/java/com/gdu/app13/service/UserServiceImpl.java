...
public class UserServiceImpl implements UserService {
	...
	public Map<String, Object> sendAuthCode(String email) {
		...
		properties.put("mail.smtp.host", "smtp.gmail.com");  // 구글 메일로 보냄(보내느 메일은 구글 메일만 가능)
		...
		/*
			...
			2. Google 계정  - 보안
				...
				2) 앱 비밀번호
					(1) 앱 선택   : 기타
					(2) 기기 선택 : Windows 컴퓨터
					(2) 생성 버튼 : 16자리 앱 비밀번호를 생성해 줌(이 비밀번호를 이메일 보낼 때 사용)
		*/
		
		// 이메일을 보내는 사용자 정보
		String username = "vvovovv18@gmail.com";  // 본인 지메일 주소
		String password = "pvasgzcsniohdxng";	  // 발급 받은 앱 비밀번호
