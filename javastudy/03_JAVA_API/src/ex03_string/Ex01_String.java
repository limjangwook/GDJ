...
public class Ex01_String {
	...
	public static void main(String[] args) {
		...
		//    1) substring(begin) : 인덱스 begin(포함)부터 끝까지
		//    2) substring(begin, end) : 인덱스 begin(포함)부터 인덱스 end(불포함)까지 포함
		...
		int idx2 = name.indexOf("장욱");
		int idx3 = name.lastIndexOf("우");
		int idx4 = name.lastIndexOf("장욱");
		...
		if(name.startsWith("임")) {
			System.out.println("임씨입니다.");
		} else {
			System.out.println("임씨가 아닙니다.");
		}
		...
		String email = "vvovovv18@gmail.com";
		...
		// 아라비아 숫자 1234567890 제외하고 한 글자씩 화면에 출력하시오.
